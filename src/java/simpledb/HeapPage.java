...
public class HeapPage implements Page {
    ...
    public HeapPage(HeapPageId id, byte[] data) throws IOException {
       ...
       // System.out.println(header.length + " header length");
        for (int i=0; i<header.length; i++) {
          ...
          //  System.out.println(header[i] + "header i constructor" + i);
        }
    ...
    */
    private int getNumTuples() {        
        // some code goes here
        return (int)Math.floor(BufferPool.getPageSize()*8/(double)(td.getSizeInBytes()*8+1));
    ...
    private int getHeaderSize() {        
        ...
        // some code goes here
        return (int)Math.ceil((double)getNumTuples()/8d);
    ...
    private class HeapPageIterator implements Iterator<Tuple> {
        ...
        private int curr;
        private HeapPageIterator(HeapPage p) {
            page = p;
            curr = 0;
        ...
        public boolean hasNext() {
            ...
            return curr < (page.getNumTuples() - page.getNumEmptySlots());
        }

        @Override
        public Tuple next() {
            return page.tuples[curr++];
        }
